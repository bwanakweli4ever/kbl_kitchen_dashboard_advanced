...
export const config = {
  // API Configuration
  api: {
    // Use localhost:8000 for local testing
    baseUrl: process.env.NEXT_PUBLIC_API_URL || process.env.WHATSAPP_API_URL || "http://localhost:8000",
    // For production: "https://backend.kblbites.com",
